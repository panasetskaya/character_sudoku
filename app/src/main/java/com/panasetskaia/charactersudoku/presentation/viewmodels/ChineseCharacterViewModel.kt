...
//todo: слушатели выбора добавить (и переменную var selectedCat, куда будем это все записывать. ее же выставлять в спиннере (не придется ли делать флоу на весь charater??))
